        ...
        <div className="relative z-10 p-6 text-app-fg">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3">
            <div className="inset-tile px-3 py-2.5">
              <p className="text-xs text-app-fg/60">Feels like</p>
              <p className="font-semibold text-app-fg">{main.feels_like != null ? Math.round(main.feels_like) : '—'}°C</p>
            </div>
            <div className="inset-tile px-3 py-2.5">
            ...
            <div className="inset-tile px-3 py-2.5">
              ...
              <p className="font-semibold text-app-fg">{wind.speed != null ? Number(wind.speed).toFixed(1) : '—'} m/s</p>
            </div>
            <div className="inset-tile px-3 py-2.5">
              <p className="text-xs text-app-fg/60">Pressure</p>
              <p className="font-semibold text-app-fg">{main.pressure ?? '—'} hPa</p>
            </div>
            <div className="inset-tile px-3 py-2.5">
              <p className="text-xs text-app-fg/60">Visibility</p>
              <p className="font-semibold text-app-fg">{data.visibility != null ? (data.visibility / 1000).toFixed(1) : '—'} km</p>
            </div>
          </div>

          {sys.sunrise && sys.sunset && (
            <div className="mt-4 flex gap-4 border-t border-app-fg/10 pt-4 text-sm text-app-fg/80">
