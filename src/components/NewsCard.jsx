  ...
  return (
    ...
    >
      <a
        ...
        className={`group flex h-full flex-col overflow-hidden rounded-2xl border border-slate-200/80 bg-white/92 shadow-md transition hover:-translate-y-1 hover:border-sky-300 hover:shadow-xl app-night:border-white/15 app-night:bg-slate-900/55 ${carouselTile ? 'max-h-[26rem]' : ''}`}
      >
